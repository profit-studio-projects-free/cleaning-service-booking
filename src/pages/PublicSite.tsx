...
export default function PublicSite() {
  ...
  useEffect(() => {
    ...
    // Demo mode: use safe fallback data so the UI never crashes or goes blank.
    ...
    async function load() {
      ...
      setBusinessHours((hrs.data ?? []) as BusinessHours[]);
      setBlockedDates((blk.data ?? []) as BlockedDate[]);
      setSettings((set.data ?? null) as BusinessSettings | null);
      setLoading(false);
    }
    load();
    return () => {
